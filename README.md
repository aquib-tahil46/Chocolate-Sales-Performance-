...
[Insert dashboard_overview.png screenshot here before publishing]
Overview
...
Full script: sql/chocolate_sales_project.sql
Dashboard features
...
Setup
1.	Run sql/chocolate_sales_project.sql against MySQL 8+ (update the LOAD DATA LOCAL INFILE paths to your local CSV locations first; requires local_infile enabled on both client and server).
...
Author: Aquib Tahil · LinkedIn · GitHub
